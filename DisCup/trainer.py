...
class Trainer(object):
    def __init__(self, args):
        ...
        self.train_steps_per_epoch = math.ceil(len(train_dataset) / args.batch_size)
    ...
    def train(self):
        ...
        for epoch_idx in range(self.args.epoch):
            ...
            tot_loss = 0
            count =0 
            for batch_idx, batch in tqdm(enumerate(self.train_loader), total=self.train_steps_per_epoch):
                self.model.train()
                x = batch[0].cuda().squeeze(1)
