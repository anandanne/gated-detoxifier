...
def run_model():
    ...
    parser.add_argument('--prompt', '-P', type=str, required=True,
                        help='prompt (sentiment, emotion, bbc-news)')
    ...
    model_paths = {
        "emotion": "../../../models/gpt2-emotion",
        "bbc-news": "../../../models/gpt2-bbc-news",
        "yelp": "../../../models/gpt2-yelp-polarity",
    }
    model = GPT2LMHeadModel.from_pretrained(model_paths[args.model])
    ...
    bow_index = None
    disc_paths = {
        "emotion": "../../../PPLM/model/emotion/toxic_classifier_head_epoch_10.pt",
        "bbc-news": "../../../PPLM/model/bbc-news/toxic_classifier_head_epoch_10.pt",
        "yelp": "../../../PPLM/model/yelp/toxic_classifier_head_epoch_10.pt",
    }
    classifier = ClassificationHead(class_size=2, embed_size=768).to(device)
    classifier.load_state_dict(torch.load(disc_paths[args.model]))
    classifier.eval()
